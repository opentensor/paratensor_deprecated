...
impl<T: Config> Pallet<T> {
    ...
    pub fn set_max_registrations_per_block( max_registrations: u16 ){ MaxRegistrationsPerBlock::<T>::put( max_registrations ); }
    ...
    pub fn get_max_registratations_per_block( ) -> u16 { MaxRegistrationsPerBlock::<T>::get() }
